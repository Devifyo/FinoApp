...
<body class="antialiased bg-gradient-to-br from-gray-50 to-gray-200 dark:from-gray-900 dark:to-gray-800 min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="w-full px-4 mx-auto sm:px-0 sm:max-w-md mb-6">
    ...
    <div class="w-full px-4 mx-auto sm:px-0 sm:max-w-md">
        <div class="glass-effect py-8 px-4 shadow-2xl rounded-2xl sm:px-10 relative overflow-hidden bg-white/80 dark:bg-gray-800/80">
